...
createdAt: '2023-08-21T01:05:00.000+09:00'
updatedAt: '2023-08-21T01:05:00.000+09:00'
preview: null
draft: false
tags:
  - tutorial
...
![Supabase](/posts/tutorials/supabase/what-is-supabase/supabase-logo.png)
...
데이터 관리 권한의 경우, PostgreSQL의 RLS(Row Level Security)와 다음 섹션에 소개할 '사용자 인증' 기능의 조합으로 간단하게 제어가 가능하다.
...
뿐만 아니라 사용자 인증용 메일(가입인증, 초대 등) 설정 및 꾸미기, 커스텀 SMTP 서버 연결,
